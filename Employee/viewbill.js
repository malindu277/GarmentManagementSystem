...
// $shopNameSql = "SELECT name FROM shop WHERE shopId = $shopId";
...
//     $pdf->SetFont('Arial', '', 12);
//     $pdf->Cell(0, 10, 'Shop Name: ' . $shopName, 0, 1, 'C'); // Add shop name
//     $pdf->Ln(10); // Add space
...
//         $pdf->Cell(50, 10, $row['itemName'], 1, 0, 'L'); // Align item name to left
...
//                 <div class="col-md-2">
//                     <img src="logo.png" alt="Dil Fashion Logo" height="50" class="img-fluid">
//                 </div>
...
//                 <a href="viewbill.php?shopId=<?php echo $shopId; ?>&download=true" class="btn btn-primary"><i class="fas fa-download"></i> Download Bill as PDF</a>
//             </div>
//             <br>
//             <br>
//         </div>
...
// <?php
// $updateTotalSql = "UPDATE bill SET total_amount = $grandTotal WHERE shopId = $shopId";
