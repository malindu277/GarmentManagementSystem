...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["username"]) && isset($_POST["password"])) {
        ...
        $stmt->execute();
        $stmt->store_result();
        $stmt->bind_result($empID,$name,$age,$dob,$nic,$address,$email,$contactno,$username,$spassword,$salaryID,$profphotoname,$profphototype,$profiphotosize,$profphotocont);
        $stmt->fetch();
        ...
        if ($password==$spassword) {
            ...
            header("Location: empView.php?id=" .$username. "&empId=". $empID);
            exit;
        } else {
            echo $empID;
            echo $username;
